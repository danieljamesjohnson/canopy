...
- [ ] **ENGINE-04**: Outcome goals are scheduled by deadline pressure, replacing the hardcoded `chunksRemaining = 2.0` placeholder.
- [ ] **ENGINE-05**: The "Want a lighter day?" toggle measurably reduces the discretionary schedule.
