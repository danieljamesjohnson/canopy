...
[testing paused — boot crash blocks remaining 12 tests; resume after fix]
...
result: issue
reported: "when i started it in macos i got an exception on this : \"FlutterLocalNotificationsPlugin.initialize (/Users/danjohnson/.pub-cache/hosted/pub.dev/flutter_local_notifications-21.0.0/lib/src/flutter_local_notifications_plugin.dart:159) NotificationService.initialize (/Users/danjohnson/CodeProjects/canopy/lib/services/notification_service.dart:62) <asynchronous gap> (Unknown Source:0) main (/Users/danjohnson/CodeProjects/canopy/lib/main.dart:30) <asynchronous gap> (Unknown Source:0)\""
severity: blocker
...
reason: "Cannot launch the app on macOS due to Test 1 boot crash"
