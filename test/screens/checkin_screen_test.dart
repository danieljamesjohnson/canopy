...
void main() {
  group('_onBgColor luminance threshold (CHECKIN-01)', () {
    ...
    test(
      'mood 1 (#4A6275, slate-blue) luminance is <= 0.35 → white foreground',
      () {
    ...
    test(
      'mood 2 (#5C7A8A, steel-blue) luminance is <= 0.35 → white foreground',
      () {
    ...
    test(
      'mood 3 (#4A8C7A, teal-green) luminance is <= 0.35 → white foreground',
      () {
    ...
    test('mood 4 (#7AAF6A, sage-green) luminance — boundary case: '
