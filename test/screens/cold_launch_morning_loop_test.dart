...
void main() {
  ...
  testWidgets(
    ...
    (tester) async {
      ...
      // empty list, matching this test's pre-Phase-35 "no calendar
      // configured" behavior exactly (NullCalendarSource, sync is a real
      // no-op, so the seeded-goal assertion below is unaffected).
