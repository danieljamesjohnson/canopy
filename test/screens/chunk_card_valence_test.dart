...
void main() {
  group('ChunkCard valence chip (ENERGY-04b)', () {
    testWidgets(
      'shows "Gives" chip when goalValence == gives',
      (tester) async {
        await pumpWithMood(
          tester,
          ChunkCard(
        ...
        expect(
          ...
          findsOneWidget,
          reason: 'Valence chip must show bolt icon for gives valence — ENERGY-04b',
        );
      },
    );

    testWidgets(
      'shows "Costs" chip when goalValence == costs',
      (tester) async {
        await pumpWithMood(
          tester,
          ChunkCard(
    ...
    testWidgets(
      'shows NO valence chip when goalValence == neutral',
      (tester) async {
        await pumpWithMood(
          tester,
          ChunkCard(
    ...
    testWidgets(
      'shows NO valence chip when goalValence is null',
      (tester) async {
        await pumpWithMood(
          tester,
          ChunkCard(
  ...
  group('ChunkCard emoji prefix (ENERGY-04b)', () {
    testWidgets(
      'emoji appears prefixed to goal name when goalEmojiTag is set',
      (tester) async {
        const knownEmoji = '⚡';
    ...
    testWidgets(
      'no emoji prefix when goalEmojiTag is null',
      (tester) async {
    ...
    testWidgets(
      'emoji + gives chip render together',
      (tester) async {
        const knownEmoji = '🌟';
        await pumpWithMood(
          tester,
